...
class BracoRobotico:
    def __init__(self, temperatura_media, corrente_media, vibracoes):
        self.motores = [
            ...
            Motor("Garra", temperatura_media, corrente_media, vibracoes[2])
        ]
...
def previsao(dia: str = '08', mes: str = '10', ano: str = '2024', msg_auto: bool = False):
    ...
    if msg_auto:
        ...
        SELECT 
            ...
            AVG(vibração_base) AS media_vibracao_base, 
            AVG(vibracao_braco) AS media_vibracao_braco, 
            AVG(vibracao_garra) AS media_vibracao_garra 
        FROM 
            dados 
        WHERE 
    ...
    temperatura, corrente, vibracao_base, vibracao_braco, vibracao_garra = dados[0]
    
    # Inicializar o braço robótico com os dados extraídos
    braco = BracoRobotico(temperatura, corrente, [vibracao_base, vibracao_braco, vibracao_garra])
